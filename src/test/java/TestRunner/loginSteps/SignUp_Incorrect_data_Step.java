...
public class SignUp_Incorrect_data_Step extends SetupClass {
...
@Given("^user is already on sign up page$")
	...
	public void user_enter_incorrect_data_in_the_sign_sig_up_form() throws InterruptedException  {
	    ...
	    Thread.sleep(2000);
	    WebElement new_fname_signup = driver.findElement(By.xpath("//*[@id='firstname']"));
	    Thread.sleep(1000);
	    new_fname_signup.sendKeys("!$#");
	    Thread.sleep(2000);
	    WebElement new_lname_signup = driver.findElement(By.xpath("//*[@id='lastname']"));
	    Thread.sleep(1000);
	    new_lname_signup.sendKeys("254204254");
	    Thread.sleep(2000);
	    WebElement new_pwd_signup = driver.findElement(By.xpath("//*[@id='password']"));
	    Thread.sleep(1000);
	    new_pwd_signup.sendKeys("123456");
	    Thread.sleep(2000);
	    WebElement new_pwd1_signup = driver.findElement(By.xpath("//*[@id='password-confirmation']"));
	    Thread.sleep(1000);
	    new_pwd1_signup.sendKeys("123456");
	    Thread.sleep(2000);
	    WebElement new_captcha_signup = driver.findElement(By.xpath("//*[@id='captcha_user_create']"));
	    Thread.sleep(1000);
	    new_captcha_signup.sendKeys("Aj7W2mtf9namwf55");
	    Thread.sleep(2000);
	    try {
				    //WebDriverWait wait = new WebDriverWait(driver, 40);
			WebElement e_lement = driver.findElement(By.xpath("/html/body/div[2]/main/div/div/div[2]/div/form/fieldset/div[8]/div[2]/div/div/button"));
			Thread.sleep(1000);
			js.executeScript("arguments[0].click();", e_lement);
			Thread.sleep(2000);
